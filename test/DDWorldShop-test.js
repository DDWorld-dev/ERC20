...
describe("DDWorldShop", function () {
    ...
    beforeEach(async function() {
      ...
      const DDWorldShop = await ethers.getContractFactory("DDWorldShop", owner)
      shop = await DDWorldShop.deploy()
      await shop.deployed()
    ...
    it("allows to buy", async function() {
      ...
      await tx.wait()
      const balanceBuyer =  await erc20.balanceOf(buyer.address)
